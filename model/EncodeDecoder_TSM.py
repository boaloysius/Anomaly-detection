...
class DownSampleModule(nn.Module):
    ...
    def forward(self, inp):
        ...
        out = self.interpolate(out, sf1=6/8, sf2=1/2, sf3=1/2)
        out = self.conv5(out)
        out = self.residual_TSM(self.conv6, out)
        
        out = self.interpolate(out, sf1=4/6, sf2=1/2, sf3=1/2)
        out = self.conv7(out)
        out = self.residual_TSM(self.conv8, out)

        out = self.interpolate(out, sf1=3/4, sf2=1/2, sf3=1/2)
        out = self.conv9(out)
        out = self.residual_TSM(self.conv10, out)
        
        out = self.interpolate(out, sf1=2/3, sf2=1/2, sf3=1/2)
        out = self.conv11(out)
...
class UpSampleModule(nn.Module):
    ...
    def forward(self, inp):
        ...
        out = self.interpolate(out, sf1=3/2,sf2=2,sf3=2)
        out = self.conv3(out)
        out = self.residual_TSM(self.conv4, out)

        out = self.interpolate(out, sf1=4/3,sf2=2,sf3=2)
        out = self.conv5(out)
        out = self.residual_TSM(self.conv6, out)

        out = self.interpolate(out, sf1=6/4,sf2=2,sf3=2)
        out = self.conv7(out)
        out = self.residual_TSM(self.conv8, out)

        out = self.interpolate(out,sf1=8/6,sf2=2,sf3=2)
        out = self.conv9(out)
        out = self.residual_TSM(self.conv10, out)
