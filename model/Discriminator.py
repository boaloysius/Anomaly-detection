...
class TemporalDiscriminator(nn.Module):
    def __init__(self, nc_in):
        ...
        # (112, 112) => (56, 56)
        self.conv2 = NN3Dby2DTSM(64, 64, kernel_size=(1, 1))
        self.conv3 = NN3Dby2DTSM(64, 64, kernel_size=(1, 1))
        self.conv4 = NN3Dby2DTSM(64, 128, kernel_size=(3, 3), stride=2,padding=1)
        
        # (56, 56) => (26, 26)
        self.conv5 = NN3Dby2DTSM(128, 128, kernel_size=(1, 1))
        self.conv6 = NN3Dby2DTSM(128, 128, kernel_size=(1, 1))
        self.conv7 = NN3Dby2DTSM(128, 256, kernel_size=(5, 5), stride=2)

        # (26, 26) => (11, 11)
        self.conv8 = NN3Dby2DTSM(256, 256, kernel_size=(1, 1))
        self.conv9 = NN3Dby2DTSM(256, 256, kernel_size=(1, 1))
        self.conv10 = NN3Dby2DTSM(256, 512, kernel_size=(5, 5), stride=2)

        #　(11, 11) => (11, 11)
        self.conv11 = NN3Dby2DTSM(512, 1024, kernel_size=(1, 1))
        self.conv12 = NN3Dby2DTSM(1024, 1024, kernel_size=(1, 1))
